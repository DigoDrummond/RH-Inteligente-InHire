/*
================================================================================
MIGRATION 065: Alterar ordenação para ASC (data_publicacao)
================================================================================

Data: 2026-02-20

OBJETIVO:
  Alterar a ordenação da view de DESC (mais recentes primeiro) para ASC
  (mais antigas primeiro) pelo campo data_publicacao (p.opened_at).

  SEM ALTERAR qualquer estrutura, campos ou cálculos da migration 064.

ANTES (Migration 064):
  - ORDER BY p.opened_at DESC NULLS LAST
  - Posições mais recentes aparecem primeiro

DEPOIS (Migration 065):
  - ORDER BY p.opened_at ASC NULLS LAST
  - Posições mais antigas aparecem primeiro

CAMPOS:
  - 34 campos (inalterados da migration 064)
  - Estrutura completa preservada

Base: Migration 064 (PRESERVANDO TUDO)
...
'View FINAL para análise de posições - Migration 065 (2026-02-20).
