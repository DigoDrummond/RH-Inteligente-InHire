/*
================================================================================
MIGRATION 071 - STEP 2: Criar View com Correções de SLA
================================================================================

IMPORTANTE: Executar este script APÓS o STEP 1 (DROP)

Este script recria a view vw_analise_posicoes com as correções de SLA
para posições pausadas.

MODIFICAÇÕES APLICADAS:
  1. CTE periodos_pausa (linha 48): CURRENT_TIMESTAMP → CURRENT_DATE
  2. Campo data_encerramento (linha 142): status paused → CURRENT_DATE
  3. SLA recrutamento 1º CASE (linha 220): status paused → CURRENT_DATE
  4. SLA recrutamento 2º CASE (linha 240): status paused → CURRENT_DATE
  5. SLA geral 1º CASE (linha 280): status paused → CURRENT_DATE
  6. SLA geral 2º CASE (linha 300): status paused → CURRENT_DATE
  7. Indicador prazo 1º CASE (linha 325): status paused → CURRENT_DATE
  8. Indicador prazo 2º CASE (linha 346): status paused → CURRENT_DATE

RESULTADO ESPERADO:
  - 11 posições com SLA negativo → SLA positivo correto
  - Posição 589: SLA recrutamento de -31 → 51 dias
