/*
================================================================================
MIGRATION 033: Dias Úteis - Versão Corrigida (Ordem de Execução Correta)
================================================================================

Data: 2026-02-06
Descrição:
  Implementa cálculo de dias úteis com ordem correta de execução.
  Resolve problema de dependências circulares.

================================================================================
*/

-- PASSO 1: Limpar tudo que possa existir (ordem correta: VIEW antes de MATERIALIZED VIEW)
...
-- PASSO 2: Criar tabela de feriados
...
-- PASSO 4: Criar função (agora que a tabela existe e está populada)
...
-- Testar a função antes de criar a view
DO $$
DECLARE
    v_teste INTEGER;
BEGIN
...
-- PASSO 5: Criar materialized view (agora que função existe e funciona)
...
BEGIN
    ...
    RAISE NOTICE '================================================================================';
    RAISE NOTICE 'MIGRATION 033 - DIAS ÚTEIS IMPLEMENTADO';
    RAISE NOTICE '================================================================================';
    RAISE NOTICE 'Posições: % (esperado: 830)', v_total_posicoes;
    RAISE NOTICE 'Feriados: %', v_total_feriados;
