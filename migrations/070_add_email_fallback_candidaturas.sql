/*
================================================================================
MIGRATION 070: Adicionar Fallback de E-mail para Candidaturas
================================================================================

Data: 2026-03-03

OBJETIVO:
  Adicionar fallback no campo email_pessoal para buscar o e-mail da tabela
  candidaturas quando o e-mail não estiver disponível na tabela talentos.

PROBLEMA IDENTIFICADO:
  - 688 posições com hired_at
  - 658 talentos encontrados
  - 620 talentos com e-mail (94.2%)
  - 68 posições sem e-mail (9.9%)

CAUSA:
  - 38 talentos sem e-mail na tabela talentos
  - Campo email_pessoal busca apenas de talentos.email

SOLUÇÃO:
  Adicionar COALESCE para buscar e-mail de candidaturas quando
  talentos.email for NULL:
...
IMPACTO ESPERADO:
  - Redução de 68 para ~23 posições sem e-mail (~66% de melhoria)
  - 100% das outras colunas inalteradas

Base: Migration 065 (PRESERVANDO TUDO, exceto linha 295)

================================================================================
*/

-- ============================================================================
-- RECRIAR VIEW COM FALLBACK DE E-MAIL
-- ============================================================================
...
SELECT
    ...
    -- 28. E-mail Pessoal (era coluna 26) -- MODIFICADO EM MIGRATION 070
    COALESCE(
        t_contratado.email,
        (SELECT cd.talent_email
         FROM candidaturas cd
...
'View FINAL para análise de posições - Migration 070 (2026-03-03).
...
CARACTERÍSTICAS:
  ...
  - email_pessoal com fallback para candidaturas
