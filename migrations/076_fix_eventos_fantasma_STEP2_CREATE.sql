/*
================================================================================
MIGRATION 076 - STEP 2: Rejeitar Eventos Fantasma (previous_status = NULL)
================================================================================
...
CAUSA RAIZ:
  ...
  - 13/06: NULL → paused (IDs 2330, 6364)
  - 26/08: NULL → paused (ID 7755)
...
RESULTADO ESPERADO:
  - Par 1: 24/06 (open→paused) → 14/07 = 14 dias ✅
  - Par 2: 29/07 (open→paused) → 05/09 = 28 dias ✅
  Total: 42 dias → SLA positivo!

MODIFICAÇÕES APLICADAS:
  Linhas 122 e 130: Remover "OR previous_status IS NULL"
...
TRADE-OFF:
  ⚠️ Pode rejeitar pausas legítimas se API registrar NULL (improvável)
  ✅ Elimina eventos fantasma que causam inflação de SLA
  ✅ Posições 782 e 1274 não afetadas (não usam NULL)

RESULTADO FINAL ESPERADO:
  - Posição 782: SLA +10 (inalterado) ✅
  - Posição 914: SLA -14 → SLA ~19 ✅
  - Posição 1274: SLA +1 (inalterado) ✅
  - 0 posições com SLA negativo no total

Base: Migration 075 (INNER JOIN para eliminar órfãos)
...
-- ============================================================================
-- PRESERVADO DE MIGRATION 075: INNER JOIN para eliminar órfãos
-- ============================================================================
periodos_pausa AS (
    ...
    INNER JOIN eventos_pausa_numerados f  -- ← PRESERVADO DE MIGRATION 075
...
-- ============================================================================
-- FIM DAS MODIFICAÇÕES - Resto permanece igual a Migration 075
-- ============================================================================
periodos_unicos AS (
    SELECT DISTINCT
        posicao_id,
...
'View FINAL para análise de posições - Migration 076 (2026-03-04).
...
correspondente). Rejeita eventos fantasma com previous_status=NULL.
Migrations 072-076 (2026-03-03/04)';
