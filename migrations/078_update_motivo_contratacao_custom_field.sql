/*
================================================================================
MIGRATION 078 - Modificar Campo motivo_contratacao com Custom Field Condicional
================================================================================

Base: Migration 077 (Fix pausas em andamento)

PROBLEMA:
  - Campo 'motivo_contratacao' usa apenas tradução de posicoes.reason
  - Ignora o custom field "Sub-motivo da Requisição" disponível em requisicoes
  - Exemplo: vaga_id 1195 tem "Leilão" no custom field, mas não aparece na view

SOLUÇÃO:
  Modificar lógica do campo motivo_contratacao (linhas 340-362) para:

  1. PRIORIDADE 1: Usar custom field "Sub-motivo da Requisição"
     - Se preenchido E diferente de "Não há"

  2. PRIORIDADE 2 (Fallback): Usar tradução de posicoes.reason
     - Quando custom field não existe, é "Não há" ou está vazio

LÓGICA SQL (MODIFICADA):
  ```sql
  CASE
...
IMPACTO:
  - Vaga 1195: motivo_contratacao passará de "Aumento de quadro" para "Leilão"
  - ~381 requisições têm este custom field preenchido
  - Mantém 34 colunas (nenhuma coluna adicionada/removida)
  - Compatível com exportação Google Sheets existente

MODIFICAÇÕES APLICADAS:
  - Linhas 340-362: Campo motivo_contratacao com lógica condicional
  - Comentário final da view atualizado
...
'View FINAL para análise de posições - Migration 078 (2026-03-16).
