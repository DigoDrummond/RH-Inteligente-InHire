/*
================================================================================
MIGRATION 035: Restaurar View (TEMPORÁRIO - Dias Corridos)
================================================================================

Data: 2026-02-06
Descrição:
  Restaura a view vw_analise_posicoes SEM cálculo de dias úteis.
  Usa dias corridos (calendário) por enquanto.

  Esta é uma solução TEMPORÁRIA para desbloquear o uso da planilha.
  Implementaremos dias úteis em uma próxima etapa.

IMPORTANTE: Esta migration FUNCIONA GARANTIDO!
...
-- Criar view regular (rápida, sem dias úteis)
...
SELECT
    ...
    -- SLA Recrutamento em DIAS CORRIDOS (temporário)
    CASE
    ...
    -- SLA Geral em DIAS CORRIDOS (temporário)
...
COMMENT ON VIEW vw_analise_posicoes IS 'View analítica com SLAs em DIAS CORRIDOS (temporário). Migration 035. Dias úteis serão implementados posteriormente.';
...
BEGIN
    ...
    RAISE NOTICE '================================================================================';
    RAISE NOTICE 'MIGRATION 035 - VIEW RESTAURADA';
    RAISE NOTICE '================================================================================';
    RAISE NOTICE 'Total de posições: % (esperado: 830)', v_total;
    RAISE NOTICE 'Posição 241 - SLA Geral: % dias CORRIDOS', COALESCE(v_sla_241::TEXT, 'NULL');
    RAISE NOTICE '';
    RAISE NOTICE 'ATENÇÃO: SLAs estão em DIAS CORRIDOS (não úteis) por enquanto.';
    RAISE NOTICE 'Esta é uma solução temporária para desbloquear a planilha.';
    RAISE NOTICE 'Implementaremos dias úteis em próxima migration.';
    RAISE NOTICE '================================================================================';
END $$;
